...
------
    ...
    php github-comment.phar "This PR is deployed to Stating" HEAD~10
...
not be guess you can use ``--organization`` and ``--repository`` option:
    ...
    php github-comment.phar "This PR is deployed to Stating" HEAD~10 --organization=lyrixx --repository=GithubComment
...
``dry-run`` option can be used to skip comment adding:
    ...
    php github-comment.phar "This PR is deployed to Stating" HEAD~10 --dry-run

This tool will ask a confirmation before sending comment to github, Use ``no-
confirmation`` option to skip confirmation.

    php github-comment.phar "This PR is deployed to Stating" HEAD~10 --no-confirmation
